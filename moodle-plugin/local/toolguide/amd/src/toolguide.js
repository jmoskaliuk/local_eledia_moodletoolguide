      ...
      React.createElement("thead",null,
        React.createElement("tr",null,
          ...
          React.createElement("th",{scope:"col",title:t(lang,"setup_help"),style:{background:"#194866",color:"white",padding:"12px 8px",textAlign:"center",minWidth:90,cursor:"help"}},
            React.createElement("div",{style:{fontSize:14,opacity:0.85},"aria-hidden":"true"},"\u2699"),React.createElement("div",{style:{fontSize:12,marginTop:2}},t(lang,"setup"))
          ),
          React.createElement("th",{scope:"col",title:t(lang,"support_help"),style:{background:"#194866",color:"white",padding:"12px 8px",textAlign:"center",minWidth:90,cursor:"help"}},
            React.createElement("div",{style:{fontSize:14,opacity:0.85},"aria-hidden":"true"},"\u{1F4AC}"),React.createElement("div",{style:{fontSize:12,marginTop:2}},t(lang,"support"))
          ),
...
function IconCC({size=18, lang}) {
  return React.createElement("img",{
    src:CC_BYNCSA_DATA,
    alt:t(lang,"alt_cc_byncsa"),
    style:{height:size,width:"auto",display:"inline-block",filter:"brightness(0) invert(1)"}
  });
}
...
function Footer({lang}) {
  return React.createElement("footer",{
    role:"contentinfo",
    style:{background:"#194866",color:"#D9D9D9",padding:"14px 24px",fontSize:11,lineHeight:1.5}
  },
    React.createElement("div",{
      ...
      React.createElement("div",{style:{flex:"1 1 420px",minWidth:260}},
        React.createElement("p",{style:{margin:"0 0 4px"}},
          ...
          " ",React.createElement("a",{href:"https://moodletoolguide.net/",target:"_blank",rel:"noopener",style:{color:"#FCBC82",textDecoration:"underline"}},"Joyce Seitzinger, Gavin Henrick & Nicolas Martignoni")
        ),
        React.createElement("p",{style:{margin:"0 0 6px"}},
          t(lang,"credit_eledia")," ",
          React.createElement("a",{href:"https://eledia.academy/",target:"_blank",rel:"noopener",style:{color:"#FCBC82",textDecoration:"underline",fontWeight:600}},"eledia.academy")
        ),
        React.createElement("div",{style:{display:"flex",alignItems:"center",gap:14}},
          ...
          }, React.createElement(IconCC,{size:22,lang:lang})),
          React.createElement("a",{
      ...
      // RIGHT: logos (eLeDia + Moodle Partner)
      React.createElement("div",{
      ...
      React.createElement("div",{style:{maxWidth:1200,margin:"0 auto"}},
        React.createElement("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:16,flexWrap:"wrap"}},
          ...
          React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}},
            React.createElement("div",{role:"group","aria-label":t(lang,"a11y_font_larger"),style:{display:"flex",gap:2,background:"rgba(0,0,0,0.2)",padding:3,borderRadius:8}},
              React.createElement("button",{onClick:()=>setFontScale(s=>Math.max(0.85,s-0.1)),title:t(lang,"a11y_font_smaller"),"aria-label":t(lang,"a11y_font_smaller"),style:{padding:"4px 9px",borderRadius:6,border:"none",background:"transparent",color:"#cbd5e1",cursor:"pointer",fontSize:12,fontWeight:600}},"A−"),
              React.createElement("button",{onClick:()=>setFontScale(1),title:t(lang,"a11y_font_reset"),"aria-label":t(lang,"a11y_font_reset"),"aria-pressed":fontScale===1,style:{padding:"4px 9px",borderRadius:6,border:"none",background:fontScale===1?"#f98012":"transparent",color:fontScale===1?"white":"#cbd5e1",cursor:"pointer",fontSize:12,fontWeight:600}},"A"),
              React.createElement("button",{onClick:()=>setFontScale(s=>Math.min(1.4,s+0.1)),title:t(lang,"a11y_font_larger"),"aria-label":t(lang,"a11y_font_larger"),style:{padding:"4px 9px",borderRadius:6,border:"none",background:"transparent",color:"#cbd5e1",cursor:"pointer",fontSize:14,fontWeight:600}},"A+")
            ),
