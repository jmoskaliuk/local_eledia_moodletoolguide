...
= 1.1.31 =
* Logotipo de partner actualizado al insignia oficial «Premium Moodle Partner Trademark™» (Primary Colour RGB).
* Añadida la documentación DevFlow en docs/ siguiendo el estándar eLeDia.OS_DevFlow.
* Limpieza del repositorio: eliminadas las notas de prototipo obsoletas (IconPreview, Konzept) y el antiguo Prototyp_ToolGuide.jsx; la fuente de la verdad es el bloque Babel dentro de Prototyp_ToolGuide.html.
