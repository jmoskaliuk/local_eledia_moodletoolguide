...
= 1.1.30 =
* Démarrage renforcé contre les problèmes d'ordre liés à l'optimisation JavaScript : le Tool Guide attend désormais le runtime React de WordPress avant le rendu.
