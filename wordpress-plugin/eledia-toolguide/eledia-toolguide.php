...
define( 'ELEDIA_TOOLGUIDE_VERSION', '1.1.26' );
...
/**
 * Load bundled translations when present.
 */
function eledia_toolguide_load_textdomain() {
...
add_action( 'plugins_loaded', 'eledia_toolguide_load_textdomain' );
